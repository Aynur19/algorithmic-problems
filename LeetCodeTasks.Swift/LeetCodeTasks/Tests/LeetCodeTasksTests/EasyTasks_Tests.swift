...
extension EasyTasks_Tests {
    ...
    //*************************** TASK 028 ***************************
    func test_strStr() throws {
        XCTAssertEqual(task.strStr("sadbutsad", "sad"), 0)
        XCTAssertEqual(task.strStr("leetcode", "leeto"), -1)
        XCTAssertEqual(task.strStr("mississippi", "pi"), 9)
        XCTAssertEqual(task.strStr("abb", "abaaa"), -1)
    }
    //*************************** TASK 028 ***************************
